...
import { doctorshomevisit } from "../redux-components/Becameparson/Becameparson/BecameSlice";
import { useNavigate } from "react-router-dom";

function DoctorOnlineAppointment() {
  ...
  const validateFields = () => {
    ...
    if (!formdata.patient_gender)
      newError.patient_gender = "Gender is required.";
    ...
    if (!formdata.house_number)
      newError.house_number = "House number is required.";
    if (!formdata.street_name)
      newError.street_name = "Street name is required.";
    ...
    if (!formdata.booking_datetime)
      newError.booking_datetime = "Appointment date and time is required.";
    ...
    try {
      const options = {
        ...
        handler: function (response) {
          ...
          dispatch(doctorshomevisit(formdata)).then((res) => {
          ...
          <div className="services-5">
            <section className="formSection">
              ...
              <div className="formcontainerDiv col-md-7">
                <h3>DOCTORS ONLINE APPOINTMENT</h3>
                  ...
                  <form onSubmit={handlePayment}>
                    <div className="inputHead">
                      <div className="customWrapper">
                        ...
                        {error.patient_name && (
                          <div className="error">{error.patient_name}</div>
                        )}
                      </div>
                      <div className="customWrapper">
                        <div className="inputFeald">
                        ...
                        {error.patient_age && (
                          <div className="error">{error.patient_age}</div>
                        )}
                      </div>
                      <div className="customWrapper">
                        <div className="inputFeald">
                        ...
                        {error.patient_gender && (
                          <div className="error">{error.patient_gender}</div>
                        )}
                      </div>
                    </div>
                    <div className="inputWrapper">
                      <div>
                        ...
                        {error.patient_email && (
                          <div className="error">{error.patient_email}</div>
                        )}
                      </div>
                      <div>
                        <div className="inputFeald">
                        ...
                        {error.patient_mobile && (
                          <div className="error">{error.patient_mobile}</div>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="inputWrapper">
                      <div>
                        ...
                        {error.house_number && (
                          <div className="error">{error.house_number}</div>
                        )}
                      </div>
                      <div>
                        <div className="inputFeald">
                    ...
                    <div className="inputWrapper">
                      <div>
                        ...
                        {error.street_name && (
                          <div className="error">{error.street_name}</div>
                        )}
                      </div>
                      <div>
                        <div className="inputFeald">
                        ...
                        {error.area && (
                          <div className="error">{error.area}</div>
                        )}
                      </div>
                    </div>
                    <div className="inputWrapper">
                      <div>
                        ...
                        {error.landmark && (
                          <div className="error">{error.landmark}</div>
                        )}
                      </div>
                      <div>
                        <div className="inputFeald">
                        ...
                        {error.locality && (
                          <div className="error">{error.locality}</div>
                        )}
                      </div>
                    </div>
                    <div className="inputWrapper">
                    ...
                    {error.complaint && (
                      <div className="error">{error.complaint}</div>
                    )}
                    </div>
                    </div>
                    <div className="inputWrapper mt-3">
                      <div>
                        Sehedule Appointment Date and Time
                        <div className="inputFeald">
                          <span className="material-symbols-outlined">
                            calendar_month
                          </span>
                        ...
                        {error.booking_datetime && (
                          <div className="error">{error.booking_datetime}</div>
                        )}
                      </div>
                      <div>
...
export default DoctorOnlineAppointment;
